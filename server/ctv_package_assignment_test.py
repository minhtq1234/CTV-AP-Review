...
from intake_contract_v2 import PdfPageLocatorV2, RosterLocatorV2
...
def _source(tmp_path):
    ...
    sheet.append(("name", "identity", "faCode", "taxId", "birthDate", "bankAccount", "serviceFee", "product", "So tien"))
    sheet.append(("Synthetic Person", "079123456781", "FA-SYNTHETIC-001", "0123456789", "1990-01-01", "123", "100", "Synthetic product", "100"))
